...
- Spyke fonctionne d'abord sur ton appareil : ton historique, tes programmes, tes photos et vidéos sont stockés localement sur ton téléphone.
- Un compte est requis pour sauvegarder ta progression en ligne et la retrouver sur un autre téléphone.
- Aucune publicité, aucun traqueur, aucun outil d'analyse d'audience, aucune revente de données.
- Tu peux supprimer ton compte et ta sauvegarde en ligne à tout moment, directement dans l'application.

## Données collectées

Quand tu crées ton compte avec Sign in with Apple :

- Ton adresse e-mail (ou l'adresse relais fournie par Apple si tu choisis « Masquer mon adresse e-mail »).
- Ton nom, si tu acceptes de le partager au moment de la connexion.
...
Tes données de compte et tes sauvegardes sont conservées tant que ton compte est actif. Quand tu supprimes ton compte (Réglages → Compte → Supprimer le compte), ton compte et l'ensemble de tes sauvegardes en ligne sont définitivement supprimés. Les données stockées localement restent sur ton appareil, sous ton contrôle.
...
- Pour toute autre demande, écris à vincent.duong.dev@gmail.com.
